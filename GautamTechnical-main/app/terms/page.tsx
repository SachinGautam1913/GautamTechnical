      ...
      <div className="max-w-4xl mx-auto px-4 pb-24">
        <div className="prose prose-lg max-w-none text-foreground/80">
          ...
          <section className="mb-12">
            ...
            <p className="mb-4">
              By accessing and using GT (GautamTechnical) services, you accept
          ...
          <section className="mb-12">
            ...
            <p className="mb-4">
              GT provides technology consulting and development services
          ...
          <section className="mb-12">
            ...
            <p className="mb-4">
              ...
              audio clips, digital downloads, and software, are owned by GT or
            ...
            <p className="mb-4">
              ...
              provide to us for the purpose of delivering our services. Upon
              full payment, we transfer ownership of the deliverables to you,
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              <li>
                <strong>Payment Schedule:</strong> Payments are due according to
                the agreed project timeline and milestones
              </li>
              <li>
                <strong>Late Payments:</strong> Late payments may incur
                additional charges and could pause project work
              </li>
              <li>
                <strong>Refunds:</strong> Refunds are provided according to our
                refund policy based on project stage and work completed
              </li>
              <li>
                <strong>Taxes:</strong> All fees are exclusive of applicable
                taxes, which will be charged additionally
              </li>
              <li>
                <strong>Currency:</strong> All payments are in Indian Rupees
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              <li>
                <strong>Timelines:</strong> Project timelines are estimates and
                may vary based on project complexity and client feedback
              </li>
              <li>
                <strong>Revisions:</strong> A reasonable number of revisions are
                included; additional revisions may incur extra charges
              </li>
              <li>
                <strong>Third-party Dependencies:</strong> Delays caused by
                third-party services or APIs are not our responsibility
              </li>
              <li>
                <strong>Acceptance:</strong> Client approval is required at each
          ...
          <section className="mb-12">
            ...
            <p className="mb-4">
              ...
              information, trade secrets, and sensitive data shared during the
              course of our business relationship. This obligation continues
              beyond the termination of our services.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="mb-4">
              In no event shall GT be liable for any indirect, incidental,
            ...
            <p className="mb-4">
              ...
              these terms or our services shall not exceed the amount paid by
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              <li>
                You remain responsible for payment of all services rendered up
                to the termination date
              </li>
              <li>
                We will deliver completed work and transfer ownership as per our
                agreement
              </li>
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              <li>
                Deliverables will be free from material defects for 30 days
                post-delivery
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <li>
                Third-party services and integrations are not covered by our
                warranties
              </li>
            </ul>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="mb-4">
              ...
              resolved through good faith negotiations. If resolution cannot be
              reached, disputes shall be subject to the exclusive jurisdiction
          ...
          <section className="mb-12">
            ...
            <p className="mb-4">
              For significant changes, we will provide reasonable notice through
              email or prominent website notices.
            </p>
          </section>
