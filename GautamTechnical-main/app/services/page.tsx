...
const services = [
  ...
  },
  {
    ...
    shortDesc:
      "Secure applications protected against threats and vulnerabilities with best practices and modern security standards.",
    fullDesc:
      ...
      <section className="pt-24 pb-20 text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="mt-6 text-lg text-foreground/70">
            Everything you need to build, launch, and scale modern digital
            products.
          </p>
        </div>
      </section>
