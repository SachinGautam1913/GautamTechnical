        ...
        <div className="max-w-3xl">
          <div className="space-y-6">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold leading-tight text-balance text-white">
              ...
              <br />
              Where Clean Code Meets Growth, Speed & Real Results
            </h1>

            {/* Subheading */}
            <p className="text-lg sm:text-xl text-white/90 leading-relaxed text-balance max-w-2xl">
              Modern Web • Apps • Growth (SEO) • eCommerce • 20+ Services{" "}
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-8">
              ...
              <a
                ...
                target="Hello! I came through your website and would like to know more about your services."
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3 rounded-md border-2 border-white/20 text-white font-medium hover:bg-white/10 transition-all duration-300"
              >
                Schedule a Call
              </a>
            </div>
